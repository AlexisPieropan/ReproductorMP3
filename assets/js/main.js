...
const songs = [
  {
    ...
    path: "./assets/songs/Caravan Palace - Wonderland.mp3",
  },
  {
    name: "Catch Me If You Can",
    author: "Alibi",
    path: "./assets/songs/Catch Me If You Can - Alibi.mp3",
  },
  {
    name: "ElectroSwing",
    author: "FunkyPanda",
    path: "./assets/songs/ElectroSwing  Lyre Le Temps -FunkyPanda.mp3",
  },
  {
    name: "The Search",
    author: "NF",
    path: "./assets/songs/NF - The Search.mp3",
  },
  {
    name: "Shadow",
    author: "Triplo Max",
    path: "./assets/songs/Triplo Max - Shadow Official.mp3",
  },
];
